...
userRoutesPost.use(ensureAuthenticated.verify)

userRoutesPost.post('/notify', verifyIsAdmin, notifyAllUsersController.handle)
userRoutesPost.get('/verify', verifyIsAdmin, (req, res) => {
